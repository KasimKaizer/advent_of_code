...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2016/day_01"
...
var testCasesOne = []tests{
	{
		"First example case",
		parse.NewTextOpener("R2, L3"), // add example input here.
		5,                             // add example expected here.
	},

	{
		"Second example case",
		parse.NewTextOpener("R2, R2, R2"), // add example input here.
		2,                                 // add example expected here.
	},

	{
		"Third example case",
		parse.NewTextOpener("R5, L5, R5, R3"), // add example input here.
