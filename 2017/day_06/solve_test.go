...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2017/day_06"
...
var testCasesOne = []tests{
	{
		"First example case",
		parse.NewTextOpener("0 2 7 0"), // add example input here.
		5,                              // add example expected here.
	},
	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		3156,                             // add actual test expected here.
	},
}
...
var testCasesTwo = []tests{
	...
	},
	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		1610,                             // add actual test expected here.
	},
}
