...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2017/day_19"
...
var testCasesOne = []tests{
	{
		...
		"ABCDEF",                          // add example expected here.
	},
...
func runTests(t *testing.T, ops func([]string) (any, error), funcName string, tests []tests) {
...
func runBenchmark(b *testing.B, ops func([]string) (any, error), test []tests) {
	if testing.Short() {
