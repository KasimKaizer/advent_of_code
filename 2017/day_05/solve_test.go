...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2017/day_05"
...
var testCasesOne = []tests{
	...
	},
	{
		...
		318883,                           // add actual test expected here.
	},
}
...
var testCasesTwo = []tests{
	{
		"First example case",
		parse.NewFileOpener("base_1.txt"), // add example input here.
		10,                                // add example expected here.
	},
	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		23948711,                         // add actual test expected here.
	},
}
...
func runBenchmark(b *testing.B, ops func([]int) int, test []tests) {
	...
	for _, tc := range test {
		...
		if err != nil {
			b.Error(err)
		} // benchmarks are inaccurate because we are modifying the input.
