...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2017/day_15"
...
var testCasesOne = []tests{
	{
		"First example case",
		parse.NewTextOpener("Generator A starts with 65\nGenerator B starts with 8921"), // add example input here.
		588, // add example expected here.
	},
	// {
	// 	"Problem case",
