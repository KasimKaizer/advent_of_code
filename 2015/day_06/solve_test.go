...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2015/day_06"
...
var testCasesOne = []tests{
	{
		"First example case",
		parse.NewTextOpener("toggle 0,0 through 999,0"), // add example input here.
		1000, // add example expected here.
	},

	{
		"Second example case",
		parse.NewTextOpener("turn on 0,0 through 999,999"), // add actual test input here.
		1000000, // add actual test expected here.
	},

	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		569999,                           // add actual test expected here.
	},
}
...
var testCasesTwo = []tests{
	{
		"First example case",
		parse.NewTextOpener("turn on 0,0 through 0,0"), // add example input here.
		1, // add example expected here.
	},

	{
		"Second example case",
		parse.NewTextOpener("toggle 0,0 through 999,999"), // add actual test input here.
		2000000, // add actual test expected here.
	},

	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		17836115,                         // add actual test expected here.
	},
}
