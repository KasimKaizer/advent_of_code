...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2015/day_19"
...
var testCasesOne = []tests{
	{
		"First example case",
		parse.NewTextOpener("H => HO\nH => OH\nO => HH\nHOH"), // add example input here.
		4, // add example expected here.
	},

	{
		"Second example case",
		parse.NewTextOpener("H => HO\nH => OH\nO => HH\nHOHOHO"), // add actual test input here.
		7, // add actual test expected here.
	},

	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		518,                              // add actual test expected here.
	},
}
...
var testCasesTwo = []tests{
...

	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		200,                              // add actual test expected here.
	},
}
