...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2015/day_07"
...
var testCasesOne = []tests{
	{
		...
		"i",
		65079, // add example expected here.
	},
	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		"a",                              // add actual test expected here.
		3176,
	},
}
...
func runTests(t *testing.T, ops func([]string, string) int, funcName string, tests []tests) {
...
func runBenchmark(b *testing.B, ops func([]string, string) int, test []tests) {
	if testing.Short() {
