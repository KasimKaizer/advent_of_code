...
import (
	...
	. "github.com/KasimKaizer/advent_of_code/2015/day_13"
...
var testCasesOne = []tests{
	{
		"First example case",
		parse.NewFileOpener("base_1.txt"), // add actual test input here.
		330,                               // add actual test expected here.
	},

	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		618,                              // add actual test expected here.
	},
}
...
var testCasesTwo = []tests{
	{
		"First example case",
		parse.NewFileOpener("base_1.txt"), // add actual test input here.
		286,                               // add actual test expected here.
	},

	{
		"Problem case",
		parse.NewFileOpener("input.txt"), // add actual test input here.
		601,                              // add actual test expected here.
	},
}
